...
class VulkanConfiguration:
    requiredVulkanVersion = "1.3.250.1"
    vulkanDirectory = "./Nut/vendor/VulkanSDK"
    ...
    def CheckVulkanSDKDebugLibs(cls):
        ...
        if not shadercdLib.exists():
            ...
            print(f"Please check you Vulkan SDK files at {os.path.abspath(cls.vulkanDirectory)}.\n(Checked https://vulkan.lunarg.com/sdk/home and find you version, Or reinstall you Vulkan SDK by installer)")
        else:
